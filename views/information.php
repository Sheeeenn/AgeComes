...
<body class="pad">
        ...
        <div class="container2 grid">
            <div class="line grid">
                ...
                <input type="text" id="lname" name="lname" class="fields span10" readonly
                    value="<?php echo $_SESSION["CardID"]; ?>">
            </div>

            <div class="line grid">
                <label for="lname" class="details span2">Name:</label>
                <input type="text" id="lname" name="lname" class="fields span10" readonly
                    value="<?php echo $_SESSION["FirstName"] . " " . $_SESSION["MiddleName"] . " " . $_SESSION["LastName"]; ?>">
            </div>
        </div>
    </div>
    ...
    <div class="space">
        <div class="bar-div">
            <a class="barcode"
                id="openModal"><?php echo $renderer->render($barcode, $barcode->getWidth() * 4, 100); ?></a>
        </div>
        <div class="button-div">
            <button onclick="location.href='/update'" class="button where2">
                <p>UPDATE</p>
            </button>
        </div>
        <div class="click-div">
